...
namespace L3.Cargo.Workstation.Buffers.HighDensity
{
    public class HighDensity : IBuffer
    {
        ...
        private string m_Name = "HighDensityCargo";
        ...
        public HighDensity()
        {
            ...
            image.Width = 32;
            image.Height = 32;
            image.Source = new BitmapImage(new Uri(@"/L3Buffer-3HighDensity;component/HighDensityOff.png", UriKind.Relative));
        ...
        public void ApplyFilter (bool enable)
        {
            ...
            if (enable)
            {
                image.Source = new BitmapImage(new Uri(@"/L3Buffer-3HighDensity;component/HighDensityOn.png", UriKind.Relative));

                if (_Effect != null)
                {
                    _Effect.EnableSquare = 0.0;
                    _Effect.EnableLog = 0.0;
                    _Effect.EnableSquareroot = 1.0;
                }
            }
            else
            {
