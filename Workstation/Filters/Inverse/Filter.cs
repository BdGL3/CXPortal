...
namespace L3.Cargo.Workstation.Filters.Invert
{
    public class Invert : IFilter
    {
        ...
        public Invert ()
        {
            ...
            image.Width = 32;
            image.Height = 32;
            image.Source = new BitmapImage(new Uri(@"/L3Filter-Invert;component/InvertOff.png", UriKind.Relative));
            m_ToolBarItem.Content = image;

            // Bind the tool tip to the resource
            var binding = new Binding("Invert");
        ...
        public void ApplyFilter (Object passedObj, Object dontCare = null)
        {
            ...
            if (enable)
            {
                ...
                image.Source = new BitmapImage(new Uri(@"/L3Filter-Invert;component/InvertOn.png", UriKind.Relative));

                dockPanel.Effect = new InvertColorEffect();
            }
            else
            {
                Image image = m_ToolBarItem.Content as Image;
