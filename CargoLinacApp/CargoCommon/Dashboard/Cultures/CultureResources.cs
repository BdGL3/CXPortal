...
namespace L3.Cargo.Common.Dashboard
{
    ...
    public class CultureResources
    {
        ...
        public static CultureInfo getCultureSetting()
        {
            ...
            CultureInfo culture = new CultureInfo(configuration.AppSettings.Settings["SelectedLanguage"].Value);
            return culture;
        }

        /// <summary>
        /// Sets the stored culture in the settings. This will be the last selected language and is persisted across shutdown.
        /// </summary>
        /// <param name="culture">The culture to set.</param>
        public static void setCultureSetting(CultureInfo culture)
        {
            Configuration configuration = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.None);
            configuration.AppSettings.Settings["SelectedLanguage"].Value = culture.ToString();
            configuration.Save();
        }
