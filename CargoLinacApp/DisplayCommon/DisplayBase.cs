    ...
    public class DisplayBase : IDisplays
    {
        ...
        protected void OpenStatusUpdateServer ()
        {
            if (_ServiceHost == null)
            {
                ...
                string uri = "net.tcp://" + System.Environment.MachineName + ":" + _Settings["DisplayPort"].Value + "/LinacComm";
        ...
        protected void InitializeSubsystemAddress ()
        {
            ...
            {
                // Request for Display update.
                string uri = "net.tcp://" + _Settings["SubsystemServer"].Value + ":" + _Settings["SubsystemPort"].Value + "/LinacComm";
