...
namespace L3.Cargo.Communications.Common
{
    public static class Utilities
    {
        ...
        /// <summary>
        /// Internet Protocol Port Domain is a string constant (implemented as a property) that may
        /// be used when constructing diagnostic messages for IP port number anomalies.</summary>
        public static string IPPortDomain { get { return "[" + IPEndPoint.MinPort.ToString() + ", " + IPEndPoint.MaxPort.ToString() + "]"; } }
        /// <summary>
