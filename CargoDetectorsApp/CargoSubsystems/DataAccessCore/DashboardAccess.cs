    ...
    public class DashboardAccess
    {
        ...
        private void OnChanged(object source, FileSystemEventArgs e)
        {
            if (e.ChangeType == WatcherChangeTypes.Changed)
                _NetworkHost.MetadataUpdate(new DiscoveryMetadata(SubsystemCommInfo.BroadcastMetaDataAssemblyTag,                  File.GetLastWriteTime(e.FullPath).ToString(_dateTimeFormat)));
        }

        private void FSWatcher_Error (object source, ErrorEventArgs e) { /*stub*/ }
